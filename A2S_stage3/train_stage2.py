...
from data import Train_Dataset, Test_Dataset, get_loader
...
def main():
    ...
    # Loading datasets
    train_loader = get_loader(config) # Train_Dataset(config) 
    ...
    for epoch in range(1, num_epoch + 1):
        ...
        # for i, idx_list in enumerate(index_list):
            ...
            images, gts = pack # train_loader.images[idx_list], train_loader.gts[idx_list]
            ...
            if epoch > 3:
                gts = (gts * lamda + torch.sigmoid(Y['final'].detach()) * (1 - lamda))
