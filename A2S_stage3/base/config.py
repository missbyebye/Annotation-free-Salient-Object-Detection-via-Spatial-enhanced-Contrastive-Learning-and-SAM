...
def base_config(cfg_dict):
    ...
    parser.add_argument('--vals', default='DUTS-TE', help='Set the testing sets') # SOD,PASCAL-S,ECSSD,DUTS-TE,HKU-IS,DUT-OMRON
    parser.add_argument('--data_path', default='/data/dataset', help='The name of network')
